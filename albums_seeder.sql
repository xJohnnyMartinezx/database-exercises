...
VALUES ('Michael Jackson', 'Thriller', 1982, 50.2, 'Pop, post-disco, funk, rock'),
       ...
       ('Grease: The Original Soundtrack', 'Grease: The Original Soundtrack from the Motion Picture', 1978, 14.4, 'Rock and roll'),
       ('Led Zeppelin', 'Led Zeppelin IV', 1971, 29.0, 'Hard rock, heavy metal, folk rock'),
       ('Michael Jackson', 'Bad', 1987, 29.0, 'Pop, rhythm and blues, funk and rock'),
